...
public class ClassController {
    ...
    @RequestMapping(name = "/{classId}", method = RequestMethod.GET)
    public String selectClass(@PathVariable("classId") int classId) {

        return "";
    }

    @RequestMapping(name = "/{classId}", method = RequestMethod.PUT)
    public String updateClass(@PathVariable("classId") int classId) {

        return "";
    }

    @RequestMapping(name = "/{classId}", method = RequestMethod.DELETE)
    public String deleteClass(@PathVariable("classId") int classId) {

        return "";
    }

    @RequestMapping(name = "/{classId}/student", method = RequestMethod.POST)
    public String enroll(@PathVariable("classId") int classId) {

        return "";
    }

    @RequestMapping(name = "/{classId}/student", method = RequestMethod.DELETE)
    public String dropClass(@PathVariable("classId") int classId) {

        return "";
    }

    @RequestMapping(name = "/{classId}/attendance", method = RequestMethod.GET)
    public String selectAttendance(@PathVariable("classId") int classId) {

        return "";
    }

    @RequestMapping(name = "/{classId}/classgroup", method = RequestMethod.GET)
    public String selectClassGroup(@PathVariable("classId") int classId) {

        return "";
    }

    @RequestMapping(name = "/{classId}/classgroup", method = RequestMethod.PUT)
